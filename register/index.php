                        ...
                        method="POST">
                            ...
                            <div class="cardBody p-4">
                                ...
                                <div class="form-group text-center">
                                    <a href="/damask" class="recover-p">Ya tienes un usuario?, Inicia Sesión aquí!</a>
                                </div>

                                <div class="form-group text-center mt-4 mb-4">
                                    <button id = "btnLogin" type="button" class="btn btn-submit-login mt-2">Registrarse</button>
                                </div>
                            </div>
                        </form>
                    </div>
